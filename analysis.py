...
peaks_16c, sig_16c = pf.peakfinder(chr16, method='peakdetect', interpolate=10, lookahead=30, res_bp=10000, fallback_span_bp=500000)
...
peak6c, sig6c = pf.peakfinder(chr6, method='peakdetect', interpolate=10, lookahead=30, res_bp=10000, fallback_span_bp=500000)
